...
export default function HomePage() {
        ...
        <PageShell>
            ...
            <section className="container mt-10 flex flex-col space-y-4">
                <div className="flex items-center justify-between">
                    <h1 className="flex-1 w-full text-sm font-semibold text-foreground">Hoy<span className="inline-block ml-3 font-serif opacity-50">{dayjs().format("DD")}</span></h1>
    ...
    <Globe
        ...
        aria-hidden
    />{" "}
    del mundo real con un ojo para el diseño. También soy fan del software de código abierto
    y de los relojes{" "}
    <Watch
        className="inline-block size-4 opacity-50"
        focusable="false"
    ...
    <br />
    <br />
    Introducido a la tecnología desde una edad temprana, llevo más de 3 años construyendo
    software. Juego con prototipos y hago de todo, desde scrapers de datos{" "}
    <Braces
        className="inline-block size-4 opacity-50"
        focusable="false"
        aria-hidden
    />
    , sitios web dinámicos y APIs, encantadoras aplicaciones nativas, simulaciones fractales,
    visualizaciones de datos y más.
    <br />
    <br />
    Fuera de la programación, disfruto de la fotografía y los viajes. Actualmente
    estudio ciencias de la computación y siempre busco nuevas formas en que la tecnología pueda
    tener un impacto positivo en las personas y mejorar constantemente a través del aprendizaje.
</p>
                <p className="text-sm text-foreground">
...
<path d="M85 42.9942V42.2032L86.295 41.7132V39.4732L85 38.9902V38.2132L89.984 40.1592V41.0202L85 42.9942ZM87.219 39.8162L86.946 39.7112V41.4682L87.219 41.3632C87.835 41.1159 88.5163 40.8569 89.263 40.5862C88.4043 40.2642 87.723 40.0075 87.219 39.8162Z" fill="#BBDBFA"/>
<path d="M87.086 44.9901L89.984 46.0121V46.7891L85 44.9691V44.1151L89.984 42.2601V43.0511L87.086 44.0941C86.6007 44.2667 86.1433 44.4161 85.714 44.5421C85.9473 44.6121 86.4047 44.7614 87.086 44.9901Z" fill="#BBDBFA"/>
<path d="M89.984 50.801H89.312V47.994H87.905V50.535H87.247V47.994H85.672V50.78H85V47.245H89.984V50.801Z" fill="#BBDBFA"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M77 54V4.37114e-08L78 0V54H77Z" fill="#BBDBFA"/>
</svg>
